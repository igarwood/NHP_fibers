%% Estimate state space generalized linear model with no history terms
...
save([save_folder,session,'_unit',num2str(spike_ind),'_',task_variant,'_','R',...
    num2str(R),'_nohist'],'xK','WK','WkuFinal','Qhat','gammahat',...
